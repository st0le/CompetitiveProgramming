...
public class Main {
    ...
    public void solve() throws Exception {
        ...
        for(int testCase = 0, T = nextInt(); testCase < T; testCase++) {
            ...
            out.println(String.format("Scenario #%d:", testCase + 1));
            out.println(s > 0 ? "impossible" : c);
            out.println();
